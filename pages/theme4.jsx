...
export default function Themes4() {
  const cardStyle = {
    borderRadius: "12px",
    ...
    >
      ...
      >
        ...
        <Link to="/userinput" style={cardTiltLeftStyle}>
          <img src="/Z4-1.png" alt="Theme 4 Card 1" style={{ width: "100%", height: "100%", objectFit: "cover", borderRadius: "12px" }} />
        </Link>

        {/* Card 2 */}
        <Link to="/userinput" style={cardStyle}>
          <img src="/Z4-2.png" alt="Theme 4 Card 2" style={{ width: "100%", height: "100%", objectFit: "cover", borderRadius: "12px" }} />
        </Link>

        {/* Card 3 */}
        <Link to="/userinput" style={cardStyle}>
          <img src="/Z4-3.png" alt="Theme 4 Card 3" style={{ width: "100%", height: "100%", objectFit: "cover", borderRadius: "12px" }} />
        </Link>

        {/* Card 4 */}
        <Link to="/userinput" style={cardTiltRightStyle}>
          <img src="/Z4-4.png" alt="Theme 4 Card 4" style={{ width: "100%", height: "100%", objectFit: "cover", borderRadius: "12px" }} />
        </Link>
      </div>
    </div>
  );
