    ...
    >
      ...
      >
        ...
        <Link to="/userinput" style={cardTiltLeftStyle}>
          <img src="/Z1-1.png" alt="Theme 1 Card 1" style={{ width: "100%", height: "100%", objectFit: "cover", borderRadius: "12px" }} />
        </Link>

        {/* Card 2 */}
        <Link to="/userinput" style={cardStyle}>
          <img src="/Z1-2.png" alt="Theme 1 Card 2" style={{ width: "100%", height: "100%", objectFit: "cover", borderRadius: "12px" }} />
        </Link>

        {/* Card 3 */}
        <Link to="/userinput" style={cardStyle}>
          <img src="/Z1-3.png" alt="Theme 1 Card 3" style={{ width: "100%", height: "100%", objectFit: "cover", borderRadius: "12px" }} />
        </Link>

        {/* Card 4 */}
        <Link to="/userinput" style={cardTiltRightStyle}>
          <img src="/Z1-4.png" alt="Theme 1 Card 4" style={{ width: "100%", height: "100%", objectFit: "cover", borderRadius: "12px" }} />
        </Link>
      </div>
    </div>
  );
